    ...
    \begin{columns}
        ...
        \begin{column}{0.48\textwidth}
            \begin{tikzpicture}
                ...
                \roundpic[xshift=-.1cm, fill=darkmode]{3.8cm}{2.5cm}{build/AR_Aeff_MST_0.40_0.45_dark.pdf}{0}{3.5}{sub:Efficiency_AR}
                ...
                \roundpic[xshift=-.1cm, fill=white]{3.8cm}{2.5cm}{build/AR_Aeff_MST_0.40_0.45_light.pdf}{0}{3.5}{sub:Efficiency_AR}
