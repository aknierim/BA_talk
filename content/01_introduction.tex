% \begin{frame}
%   \centering
%   \includegraphics[width=0.6\textwidth]{graphics/cherenkov.jpg}
%   \vspace{-0.25cm}
%   \ifthenelse{\equal{\theme}{\string 1}}
%   {% use dark theme
%   \footnote{\href{https://www.flickr.com/photos/cta_observatory/45643242354/in/photostream/}{\textcolor{white!85!black}{Image Credit: R. White (MPIK) / K. Bernlohr (MPIK) / DESY}}}
%   }
%   {% use light theme
%   \footnote{\href{https://www.flickr.com/photos/cta_observatory/45643242354/in/photostream/}{\textcolor{darkgray!85!black}{Image Credit: R. White (MPIK) / K. Bernlohr (MPIK) / DESY}}}
%   }
% \end{frame}
\begin{frame}
  \centering
  \includegraphics[height=0.9\textheight]{build/tikz/iact.pdf}
