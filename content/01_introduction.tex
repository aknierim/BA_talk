\begin{frame}
  ...
  \begingroup
  \centering
  \scalebox{0.76}{\input{content/intro_tikz/iact_dark.tex}}
  \endgroup
  ...
  \begingroup
  \centering
  \scalebox{0.76}{\input{content/intro_tikz/iact_light.tex}}
  \endgroup
...
% \begin{frame}
%   \centering
%   \includegraphics[height=0.9\textheight]{build/tikz/iact_dark.pdf}
%   \footnote{\href{https://www.flickr.com/photos/cta_observatory/45643242354/in/photostream/}{\textcolor{white!85!black}{Adapted from: R. White (MPIK) / K. Bernlohr (MPIK) / DESY}}}
% \end{frame}
