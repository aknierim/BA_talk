\begin{frame}[t]{Cleaning Algorithms}
    ...
    \begin{overlayarea}{0.36\textwidth}{3.5cm}
      ...
      \only<6>{
        \includegraphics[width=\textwidth]{plots/cleaner_steps/dark/tail_3.pdf}
      }
      \only<7>{
      \begin{itemize}
        \setlength\itemsep{1em}
      ...
      \only<12>{
        \includegraphics[width=\textwidth]{plots/cleaner_steps/dark/mars_4.pdf}
      }
      \only<13>{
      \begin{itemize}
        \setlength\itemsep{1em}
    ...
    \begin{overlayarea}{0.58\textwidth}{3.5cm}
      ...
      \begin{enumerate}%TailcutsImageCleaner
        ...
        \item Remove pixels with less than \(N\) neighbors (\(N = 1\))
      ...
      \begin{enumerate}%TailcutsImageCleaner
        ...
        \item \textcolor{white!50!black}{Remove pixels with less than \(N\) neighbors (\(N = 1\))}
      ...
      \begin{enumerate}%MARSImageCleaner
        \item Analogous to \code{white!70!black}{TailcutsImageCleaner}
      ...
      \only<8>{
      \begin{enumerate}%MARSImageCleaner
        \item \textcolor{white!50!black}{Analogous to \code{white!35!black}{TailcutsImageCleaner}}
