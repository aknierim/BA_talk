...
\begin{tikzpicture}
  ...
  \draw[maincolour!40!transparent] (-7, 0.8) -- (14, 0.8); % to[out=-5,in=5]
  }

  \node[xshift=\globalshift+1cm] at (8,2.3) {\reflectbox{\includegraphics[height=0.4cm]{build/tikz/xkcd_dark.pdf}}};
  ...
  % \begin{scope}[shift={(10.9304,23.2905)}]
  %   \path[draw=black,fill=black,line width=0.077pt] (-2.2987,-5.5749) ellipse (0.0154cm and 0.0152cm);
  %   \path[draw=black,fill=black,line width=0.077pt] (38.4671,-0.2547) ellipse (0.0059cm and 0.0057cm);
  %   \path[draw=black,fill=black,line width=0.077pt] (9.1911,87.3026) ellipse (0.0045cm and 0.0044cm);
  %   \path[draw=black,fill=black,line width=0.077pt] (53.9064,78.7043) ellipse (0.0053cm and 0.0050cm);
  %   \path[draw=black,fill=black,line width=0.077pt] (17.9687,45.0788) ellipse (0.0048cm and 0.0052cm);
  %   \path[draw=black,fill=black,line width=0.077pt] (24.0412,40.9732) circle (0.0043cm);
  %   \path[draw=black,fill=black,line width=0.077pt] (29.6516,36.0263) circle (0.0042cm);
  % \end{scope}
