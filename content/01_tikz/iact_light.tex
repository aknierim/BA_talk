...
\begin{tikzpicture}
  ...
  % CHERENKOV RADIATION
  \only<4>{
    \node [] at (-2.3, 6) {\includegraphics[height=5.7cm]{build/tikz/cherenkov_radiation.pdf}};
  }
  ...
  % HEITLER MODEL
  \only<3>{
    \node [] at (-2.3, 6) {\includegraphics[height=5.7cm]{build/tikz/heitler_model.pdf}};
  }
  ...
  % CAMERA FRAME
  \uncover<5->{
    \node [circle, draw, color=maincolour, fill=white, minimum width = 4cm, path picture = {
