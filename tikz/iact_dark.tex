...
\xdefinecolor{maincolour}{HTML}{ffffff}
...
% \pagecolor{darkmode}
    \begin{tikzpicture}
      ...
      \node[] at (8,2.3) {\reflectbox{\includegraphics[height=0.4cm]{build/tikz/xkcd_dark.pdf}}};


      \fill[opacity=0.7, path fading=fade30, left color=cherenkov_blue, right color=cherenkov_blue] (0,8) -- (3,0) -- (9,0) -- cycle;
      \draw[yellow] (-0.65,9) -- (0.1,7.85) node[midway, above right, maincolour] {$\gamma$};
