...
\begin{document}
\begin{tikzpicture}[white, scale=0.750, every node/.style={scale=0.6}]
    ...
    \node at (4.5,1.74) [above] {\includegraphics[width=3.5cm]{logos/ctapipe_logo_light.pdf}};
    \node at (4.5,1.74) {Commit \texttt{f26107fe}}; %v0.15.1.dev166+gf26107f
